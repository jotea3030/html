...
<body>
    <div class="game-container">
        ...
        <div id="gameContent" style="display: none;">
            <div class="info-box">
                <p><strong>🎵 About the recordings:</strong> This game uses curated bird songs from professional field recordings. Each recording includes attribution and links to the full colle[...]</p>
            </div>
            ...
            <div class="controls">
                <button class="btn btn-secondary" id="replayButton" disabled>🔄 Replay Song</button>
